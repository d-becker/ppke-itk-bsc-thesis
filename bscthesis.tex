...
OPS supports \textit{distributed memory paralellism} by automatically
...
to mimimise the necessary communication between the MPI processes and balance
...
Lazy execution is another technique with which OPS seeks to improve its
