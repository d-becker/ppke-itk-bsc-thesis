...
This chapter gives an overwiew of the methods and tools that were used in
...
grid point. Afterwards, we will give some background information on the features
of the host language of our eDSL, C++, that make it possible to embed the our
domain specific language in it.
